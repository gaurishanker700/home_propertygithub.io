...
{    
                ...
                $subject = $_POST['subject'];
                $message= $_POST['message'];
    $query="update register set ,name='$name',email='$email',subject='$subject',message='$message'where name=$name ";
    $result=mysqli_query($con,$query);
    if($result)
    {
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="aa-header-left">
                  ...
                  <div class="aa-email hidden-xs">
                    <span class="fa fa-envelope-o"></span> gaurishanker97790@gmail.com
                  </div>
                </div>              
              </div>
              <div class="col-md-6 col-sm-6 col-xs-6">
          ...
          <div class="aa-contact-area">
            <div class="aa-contact-top">
              ...
              <div class="aa-contact-top-right">
                <h2>Contact</h2>
                <p>home pro[erty provide you best range of house</p>
                <ul class="contact-info-list">
                  <li> <i class="fa fa-phone"></i> 7009101449</li>
                  <li> <i class="fa fa-envelope-o"></i> gaurishanker97790@gmail.com</li>
            ...
            <div class="aa-contact-bottom">
              ...
              <div class="aa-contact-form">
                <form class="contactform" method="POST" >                  
                  ...
                  <p class="form-submit">
                    <input type="submit" name="submit" class="aa-browse-btn" value="update">
                  </p>        
                </form>
              </div>
            </div>
