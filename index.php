              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="aa-header-left">
                  ...
                  <div class="aa-email hidden-xs">
                    <span class="fa fa-envelope-o"></span> gaurishankerpctebtech2020@gmail.com
                  </div>
                </div>              
              </div>
              <div class="col-md-6 col-sm-6 col-xs-6">
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                <div class="aa-about-us-right">
                  ...
                  <p>At Home Property, our goal is to give people the confidence and courage to buy their first home or investment sooner. We believe in the power of property in giving you freedom and control over your future.

Over the past 4 years, we have assisted over 200 buyers get into the market across SEQ.

Our HQ is on the Sunshine Coast in Queensland, and we work across the Gold Coast, Ipswich and Logan regions, as well as all through Brisbane, Moreton Bay and the Sunshine Coast. We also love a gander up to Gympie!</p>                  
    ...
    <div class="container">
      <div class="aa-latest-property-area">
        <div class="aa-title">
          ...
          <span></span>
          <p>California's overall property taxes are below the national average. The average effective property tax rate in California is 0.73%, compared to the national rate, which sits at 1.07%.</p>         
        </div>
              ...
              <article class="aa-properties-item">
                ...
                <div class="aa-properties-item-content">
                  ...
                  <div class="aa-properties-about">
                    <h3><a href="#">villah</a></h3>
                    <p>A villa is a type of house that was originally an ancient Roman upper class country house. </p>                      
                  </div>
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                ...
                <div class="aa-properties-item-content">
                  ...
                  <div class="aa-properties-about">
                    <h3><a href="#">bunglow</a></h3>
                    <p>bungalow, single-storied house with a sloping roof, usually small and often surrounded by a veranda.</p>                      
                  </div>
                  <div class="aa-properties-detial">
                    <span class="aa-price">
                      $11000
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                ...
                <div class="aa-properties-item-content">
                  ...
                  <div class="aa-properties-about">
                    <h3><a href="#">Antilia</a></h3>
                    <p>Antilia is a private residence in the billionaires row of Mumbai, India, named after the mythical island Antillia</p>                      
                  </div>
                  <div class="aa-properties-detial">
                    <span class="aa-price">
                      $15000
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                ...
                <div class="aa-properties-item-content">
                  ...
                  <div class="aa-properties-about">
                    <h3><a href="#">bhawan</a></h3>
                    <p>The Rashtrapati Bhavan is the official residence of the President of India at the western end of Rajpath, Raisina Hill, New Delhi, India.</p>                      
                  </div>
                  <div class="aa-properties-detial">
                    <span class="aa-price">
                      $35000
              ...
              <article class="aa-properties-item">
                ...
                <div class="aa-properties-item-content">
                  ...
                  <div class="aa-properties-about">
                    ...
                    <p>An apartment is a private residence in a building or house that's divided into several separate dwellings. An apartment can be one small room or several.</p>                      
                  </div>
                  <div class="aa-properties-detial">
                    <span class="aa-price">
                      $11000
        ...
        <div class="col-md-12">
          <div class="aa-agents-area">
            <div class="aa-title">
              <h2>Our Agents</h2>
              <span></span>
              <p>our agents are best to give you compelete details about property there details are given below </p>
            </div>
            <!-- agents content -->
                ...
                <li>
                  <div class="aa-single-agents">
                    <div class="aa-agents-img">
                      <img src="img/agents/agent-1.jpg" alt="agent member image">
                    </div>
        ...
        <div class="col-md-12">
          <div class="aa-client-testimonial-area">
            <div class="aa-title">
              ...
              <span></span>
              <p>home property is very good website for those who searching for a new home</p>
            </div>
            <!-- testimonial content -->
        ...
        <div class="col-md-12">
          <div class="aa-latest-blog-area">
            <div class="aa-title">
              <h2>Latest News</h2>
              <span></span>
              <p>GST rate slash for affordable hsg doesn’t benefit flat buyers</p>
            </div>
                ...
                <div class="col-md-4">
                  <article class="aa-blog-single">
                    ...
                    <div class="aa-blog-single-content">
                      <h3><a href="#">blog</a></h3>
                      <p>A property tax or millage rate is an ad valorem tax on the value of a property. The tax is levied by the governing authority of the jurisdiction in which the property is located. </p>
